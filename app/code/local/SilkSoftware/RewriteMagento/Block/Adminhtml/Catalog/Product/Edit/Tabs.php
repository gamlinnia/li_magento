<?php
class SilkSoftware_RewriteMagento_Block_Adminhtml_Catalog_Product_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($setId) {
            ...
            $this->addTab('select_videos', array(
...
//            //add by tim
            $this->addTab('channelreviews', array(
                'label'     => Mage::helper('catalog')->__('Channel Reviews'),
                'url'       => $this->getUrl('*/*/channelreviews', array('_current' => true)),
                'class'     => 'ajax',
            ));
        ...
        if ($setId) {
            ...
            $this->addTab('user_manuals', array(
                'label'     => Mage::helper('catalog')->__('Downloads'),
                'content'   =>$this->getLayout()->createBlock('rewritemagento/adminhtml_catalog_product_edit_tabs_usermanuals')->toHtml(),
            ));



            $this->addTab('change_log', array(
                'label'     => Mage::helper('catalog')->__('Change Log'),
                'content'   =>$this->getLayout()->createBlock('rewritemagento/adminhtml_catalog_product_edit_tabs_changelog')->toHtml(),
            ));
